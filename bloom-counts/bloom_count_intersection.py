...
try:
    ...
    file_result = sys.argv[6]



except IndexError:
    print "Usage: python bloom_count_intersection_v1.1.py <1st_dataset_file> <K_size> <Hashtable_size> <Hashtable_number> <2nd_dataset_file> <output_statistics>"
    exit()
